...
| PATCH  | `/api/issues/{issueId}`       | Body: `{ "status": "open"                                           | "in_progress"                                                           |
| POST   | `/api/issues/{issueId}/waive` | Body: `{ "reason": string, "reviewer": string }`                    | Result of waive command.                                                |
| POST   | `/api/lore/delta`             | Body: `{ "scope": "chapter"                                         | "project", "id"?: number, "since"?: string }`                           |
...
| Method | Path                                              | Request                                                                            | Response `data`                                                                                                        |
| ------ | ------------------------------------------------- | ---------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------- |
| POST   | `/api/reports/build`                              | Body: `{ "scope": "chapter"                                                        | "project", "id"?: number }`                                                                                            |
