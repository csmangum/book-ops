...
export type ApiRunsListData = ApiComponents["schemas"]["RunsListData"];
export type ApiRunEntry = ApiComponents["schemas"]["RunEntry"];
export type ApiChapterContentData = ApiComponents["schemas"]["ChapterContentData"];
export type ApiCanonGraphData = ApiComponents["schemas"]["CanonGraphData"];
export type ApiRulesData = ApiComponents["schemas"]["RulesData"];
export type ApiSettingsData = ApiComponents["schemas"]["SettingsData"];
export type ApiSettingsPatchRequest = ApiComponents["schemas"]["SettingsPatchRequest"];
